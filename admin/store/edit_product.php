...
?>
<title> Hotel | Edit Product</title>
...
<h3 class="text-center text-info"><?php echo strtoupper($user_data['department']) .' DEPARTMENT <br><br> '. ucwords($user_data['last_name'].' '.$user_data['first_name']); ?>'s Edit Product page</h3>	
<?php


if(isset($_GET['success']) === true && empty($_GET['success']) === true){
	alert_success('Product has been Updated Successfully.');
	...
	update_customer($update_data, null, 'store_products', $id);
	header('Location: edit_product.php?success');
	exit();
...
foreach(get_available_store(null, 'store_products', null, $id) as $store_data){
?>
	...
	<form action="" method="post" role="form" class="form-horizontal text-center">
				<div class="form-group"> 
					...
					<div class="col-md-4">
						...
						<input type="text" name="product_name" id="product_name" class="form-control" placeholder="Product Name*" id="" value= "<?php if(isset($_POST['product_name'])){echo $_POST['product_name'];}else{ echo $store_data['product_name'];}?>" readonly>
				...
				<div class="form-group">
					<div class="col-md-12">
						<button type="submit" id="" name="submit" class="btn btn-success">Update Product</button>
					</div>
				</div>
