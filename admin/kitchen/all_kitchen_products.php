...
<h3 class="text-center text-info"><?php echo strtoupper($user_data['department']) .' DEPARTMENT <br><br> '. ucwords($user_data['last_name'].' '.$user_data['first_name']); ?>'s All Food Page</h3>
...
<?php foreach(get_bar_category('kitchen_products', $category) as $store_data){ ?>
			...
			<tr>
				...
				<td>
					<form method="get" action="edit_kitchen_products.php">
						<input type="hidden" name="id" value="<?php echo $store_data['id'] ;?>">
						<button type="submit" class="btn btn-info">Edit</button>
					</form>
				</td>
				<td>
					<form method="post" action="delete_kitchen_products.php">
