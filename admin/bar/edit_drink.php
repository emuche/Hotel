...
<h3 class="text-center text-info"><?php echo strtoupper($user_data['department']) .' DEPARTMENT <br><br> '. ucwords($user_data['last_name'].' '.$user_data['first_name']); ?>'s Edit Drink page</h3>	
<?php


if(isset($_GET['success']) === true && empty($_GET['success']) === true){
	alert_success('Drink has been Updated');
	...
	update_customer($update_data, null, 'bar_products', $id);
	header('Location: edit_drink.php?success');
	exit();
...
foreach(get_available_store(null, 'bar_products', null, $id) as $store_data){
?>
	...
	<form action="" method="post" role="form" class="form-horizontal text-center">
				<div class="form-group"> 
					...
					<div class="col-md-4">
						...
						<input type="text" name="drink_name" id="drink_name" class="form-control" placeholder="Drink Name*" id="" value= "<?php if(isset($_POST['drink_name'])){echo $_POST['drink_name'];}else{ echo $store_data['drink_name'];}?>" readonly>
				...
				<div class="form-group">
					<div class="col-md-12">
						<button type="submit" id="" name="submit" class="btn btn-success">Update Drink</button>
					</div>
				</div>
